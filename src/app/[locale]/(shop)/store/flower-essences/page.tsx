      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="text-center space-y-4">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-clip-text text-transparent bg-linear-to-r from-purple-600 to-blue-600 dark:from-purple-400 dark:to-blue-400 leading-normal">
              {t("title")}
            </h1>
          ...
          <div className="prose dark:prose-invert max-w-none space-y-8">
            <div className="p-6 bg-white/5 backdrop-blur-xs rounded-lg border border-purple-500/10 shadow-lg">
          ...
          <div className="flex flex-col items-center space-y-6 pt-8">
            ...
            >
              <Button
                size="lg"
                className="bg-linear-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white shadow-lg px-8 py-6 text-lg h-auto"
              >
                {t("cta")}
              </Button>
            </Link>
